...
#write_csv(fa.cell.neg.modSV.resid, path = "./results/modsv_resid/fa_cell_neg_modSV_resid.csv")
#write_csv(fa.cell.pos.modSV.resid, path = "./results/modsv_resid/fa_cell_pos_modSV_resid.csv")
#write_csv(fa.med.neg.modSV.resid, path = "./results/modsv_resid/fa_media_neg_modSV_resid.csv")
#write_csv(fa.med.pos.modSV.resid, path = "./results/modsv_resid/fa_media_pos_modSV_resid.csv")
```
