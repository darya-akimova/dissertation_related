...
all3.grid.alt
#save_plot(filename = "./results/vpa_mesc_all3_alt.png", all3.grid.alt, base_width = 9, base_height = 8)
#save_plot(filename = "./results/vpa_mesc_dependency.png", dependency.plot, base_width = 6, base_height = 4)
#save_plot(filename = "./results/vpa_mesc_capacity_updt.png", capacity.plot, base_width = 6, base_height = 4)
#save_plot(filename = "./results/vpa_mesc_flex_updt.png", flex.plot, base_width = 6, base_height = 4)
```
